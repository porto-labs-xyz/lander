    ...
    <figure className="performer-share">
      <div className="performer-share-heading">
        <div>
          ...
          <h3>What the performer keeps for every £1 a UK stream generates</h3>
        </div>
        <strong>8p of £1</strong>
      </div>
      <svg viewBox="0 0 1000 118" role="img" aria-labelledby="performer-share-title performer-share-description">
        <title id="performer-share-title">Performers receive roughly eight pence of every pound generated by a UK stream.</title>
        <desc id="performer-share-description">A hand-drawn progress bar with the first eight percent highlighted in Porto red.</desc>
        <defs>
        ...
        <path className="share-track" d="M8 24 C190 20 347 26 506 22 C684 18 837 25 992 21 L991 82 C816 86 668 80 501 84 C334 88 180 80 9 84 Z" />
        <path className="share-fill" d="M9 25 C31 23 56 24 88 23 L87 83 C55 82 31 83 9 84 Z" />
        <path className="share-hatch" d="M9 25 C31 23 56 24 88 23 L87 83 C55 82 31 83 9 84 Z" />
        <path className="share-divider" d="M89 17 C86 39 91 62 87 91" />
        <text className="share-eight" x="49" y="62">8p</text>
        <text className="share-total" x="982" y="110">£1.00 generated</text>
      </svg>
      <figcaption>UK streaming data point. A UK stream generates an average of £0.011.</figcaption>
    </figure>
  )
}
...
export const Head = () => (
  <>
    ...
    <meta property="og:image" content="https://www.portolabs.xyz/images/og-image-perspective-circuit-1200x630.png?v=20260910-9" />
    <meta property="og:image:secure_url" content="https://www.portolabs.xyz/images/og-image-perspective-circuit-1200x630.png?v=20260910-9" />
    ...
    <meta name="twitter:image" content="https://www.portolabs.xyz/images/og-image-perspective-circuit-1200x630.png?v=20260910-9" />
