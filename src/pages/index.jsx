    ...
    <>
      ...
      <main id="main">
        ...
        <section className="section roadmap-section" id="roadmap">
          <p className="eyebrow">05 / Roadmap</p><h2>Prove the model.<br /> Open the rails.</h2>
          ...
          <div className="roadmap-catalyst"><p className="eyebrow">Go-to-market</p><h3>The Catalyst Moment</h3><p>The city rollout makes Porto locally useful. The catalyst moment turns that proof into cultural momentum: a major artist joins, a meaningful independent label brings catalog depth, or a wider cultural moment makes Porto the visible counterexample to the existing model. The network is ready before that point arrives. The moment gives more artists and listeners a reason to move.</p></div>
        </section>
