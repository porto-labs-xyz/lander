    ...
    <figure className="performer-share">
      <div className="performer-share-heading">
        <div>
          ...
          <h3>Traditional UK streaming leaves performers with 8p. Porto lets an independent artist claim up to 70p.</h3>
        </div>
      ...
      <svg viewBox="0 0 1000 230" role="img" aria-labelledby="performer-share-title performer-share-description">
        ...
        <desc id="performer-share-description">A pair of hand-drawn progress bars. Traditional UK streaming leaves performers with eight pence of every pound generated by a UK stream. Porto allocates seventy pence to rights holders, which an independent artist holding all declared rights can claim.</desc>
        <defs>
        ...
        <text className="share-label" x="8" y="15">TRADITIONAL PLATFORMS / PERFORMER SHARE</text>
        ...
        <text className="share-note" x="110" y="68">TO THE PERFORMER</text>
        <text className="share-total" x="982" y="114">£1.00 generated</text>
        <text className="share-label" x="8" y="142">PORTO / INDEPENDENT ARTIST</text>
        ...
        <text className="share-note share-note-light" x="712" y="195">RIGHTS-HOLDER POOL</text>
        <text className="share-total" x="982" y="229">£1.00 allocated</text>
      </svg>
      <figcaption>Traditional UK performer share: 8p. Porto allocates 70p to rights holders, then applies registered rights splits. An independent artist holding all declared rights can claim up to 70p.</figcaption>
    </figure>
  )
}
